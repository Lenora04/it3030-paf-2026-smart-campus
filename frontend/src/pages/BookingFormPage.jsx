...
export default function BookingFormPage() {
  ...
  // ResourceAvailabilityModal passes preSelected via navigation state
      ...
      <div style={{ maxWidth: 700, margin: '24px auto', padding: '0 24px' }}>
        <button onClick={() => navigate(-1)}
          style={{ display:'flex', alignItems:'center', gap:6, background:'white',
            border:'1.5px solid #e5e7eb', borderRadius:8, padding:'7px 14px',
            cursor:'pointer', fontSize:13, color:'#374151', marginBottom:20 }}>
          ← Back
        </button>
